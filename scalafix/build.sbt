...
lazy val output = projectMatrix
  .settings(
    ...
    libraryDependencies += "io.janstenpickle" %% "trace4cats-avro-exporter" % "0.14.0",
    libraryDependencies ++= Seq(
      "io.janstenpickle" %% "trace4cats-avro-kafka-exporter",
      "io.janstenpickle" %% "trace4cats-avro-kafka-consumer"
    ).map(_ % "0.14.0"),
    ...
    libraryDependencies += "io.janstenpickle" %% "trace4cats-datadog-http-exporter"  % "0.14.0",
    libraryDependencies += "io.janstenpickle" %% "trace4cats-newrelic-http-exporter" % "0.14.0",
    libraryDependencies += "io.janstenpickle" %% "trace4cats-zipkin-http-exporter"   % "0.14.0",
    libraryDependencies += "io.janstenpickle" %% "trace4cats-kafka-client"           % "0.14.0",
  )
  .defaultAxes(VirtualAxis.jvm)
  .jvmPlatform(scalaVersions = rulesCrossVersions :+ scala3Version)
